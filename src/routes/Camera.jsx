    ...
    <>
      <div className="camera_img">
        ...
        <canvas
          className="hidden"
          id="canvas"
          wcrossorigin="anonymous"
        ></canvas>
      </div>

      {/* この中にimgがはいる */}
      <article
        className="fixed top-0 left-0 h-[754px] w-[100dvw]"
        id="content_area"
      ></article>
      <div
      ...
      <p className="text-btntext text-center w-[68%] borders font-bold text-base fixed left-1/2 top-[45%] translate-x-[-50%]">
        ワクの中にぬりえをおさめてね！
      </p>
      <p className="text-btntext w-[90%] borders text-center font-bold text-lg fixed left-1/2 top-[80%] translate-x-[-50%]">
        上手く読み込めない場合は、
        <br />
        お近くのスタッフにお声がけください。
      </p>
