function Decide() {
  ...
  return (
    <>
      <p className="text-btntext font-bold rounded border-main border-2 px-[27px] py-[7px] border-solid fixed decide top-[90%] right-[5%] text-[18px] hidden"onClick={() => photo_view() }>続ける</p>
    </>
  )
}
