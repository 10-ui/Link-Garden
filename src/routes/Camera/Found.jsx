      ...
      <div className='bg-screen nice relative h-screen w-screen z-[0] hidden'>
        <div className="mx-[30px]">
          ...
          <p><ruby>自然界<rp>(</rp><rt>しぜんかい</rt><rp>)</rp></ruby>にいる
            ...
            <ruby>生息<rp>(</rp><rt>せいそく</rt><rp>)</rp> </ruby>しています。
            そのため<ruby>動物園<rp>(</rp><rt>どうぶつえん</rt><rp>)</rp></ruby>で
            <ruby>飼育<rp>(</rp><rt>しいく</rt><rp>)</rp></ruby>されている
            フラミンゴには<ruby>仲間<rp>(</rp><rt>なかま</rt><rp>)</rp> </ruby>が
            ...
            <ruby>工夫<rp>(</rp><rt>くふう</rt><rp>)</rp></ruby>をしています。
            では、<ruby>実際<rp>(</rp><rt>じっさい</rt><rp>)</rp></ruby>に
            <ruby>鏡<rp>(</rp><rt>かがみ</rt><rp>)</rp></ruby>のある<ruby>環境<rp>(</rp><rt>かんきょう</rt><rp>)</rp></ruby>で
            <ruby>過<rp>(</rp><rt>す</rt><rp>)</rp></ruby>ごしている
            フラミンゴの<ruby>様子<rp>(</rp><rt>ようす</rt><rp>)</rp></ruby>を
            <ruby>見<rp>(</rp><rt>み</rt><rp>)</rp></ruby>てみましょう！</p>
        </div>
      </div>
