    ...
    navigator.bluetooth
      ...
      .then((device) => {
        ...
        device.addEventListener('advertisementreceived', (event) => {
          ...
          if (
            beacon_select.name == beacon_check.name &&
            beacon_select.count > beacon_count
          ) {
    ...
    <>
      ...
      <div className="UI hidden">
        <img
          ...
          id="animals"
          src={Fla}
          className="w-1/2 h-1/2 check fixed left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]"
          alt="普通のフラミンゴ"
        />
        <img
          className="mirror w-screen fixed left-1/2 top-[20%] translate-x-[-50%] hidden"
          src={Flamirror}
          alt="フラミンゴがたくさん映る鏡"
        />
        <div className="comment w-screen h-[190px] fixed left-1/2 top-[60%] translate-x-[-50%] hidden">
          ...
          <p className="block z-[50] w-[89dvw] fixed left-1/2 top-[52%] translate-x-[-50%] translate-y-[-52%]">
            の。
            <ruby>
              自分<rp>(</rp>
              <rt>じぶん</rt>
          ...
          <p className="block z-[50] w-[90dvw] fixed left-1/2 top-[75%] translate-x-[-50%] translate-y-[-75%]">
            で
            <ruby>
              安心<rp>(</rp>
              <rt>あんしん</rt>
          ...
          <p
            className="text-accent seemore z-[50] w-[25%] fixed right-[10%] top-[95%] translate-x-[-10%] translate-y-[-95%] hidden"
            onClick={() => Found()}
          >
            もっと見る
          </p>
          <img
            className="z-[49] w-[95%] fixed left-1/2 top-[40%] translate-x-[-50%] translate-y-[-40%]"
            src={Comment}
            alt="喜んでるときの吹き出し"
          />
        </div>
        ...
        <div className="animalbox hidden fixed z-[40] h-screen w-auto items-center">
          <div className="happy fanimal hidden fixed left-[40%] top-[20%] translate-x-[-45%] translate-y-[-20%]">
            ...
            />
            <img
              className="fananimal hidden lotfun"
              src={Flafav3}
              alt="喜ぶフラミンゴ"
            />
          </div>
          ...
          <div className="komaru hidden w-[80%] fixed top-[35%] left-1/2 translate-x-[-50%] translate-y-[-35%]">
        ...
        <div className="itemholder h-[90px] w-[100%] rounded-t-[20px] fixed z-30 bottom-0 left-0 bg-main">
          <div className="flex justify-between mt-[-35px] w-[100%]">
            <img
              ...
              src={branch}
              alt="えだ"
              className="items mt-[-20px] w-[17%] h-[115px]"
            />
            <img
              onClick={() => render(1, 'ロープ')}
              src={rope}
              alt="ロープ"
              className="items mt-[-8px] ml-[-5%] w-[20%] h-[105px]"
            />
            <img
              onClick={() => render(2, 'ダンボール')}
              src={cardboard}
              className="items w-[21%] mt-[-5px]"
              alt="ダンボール"
            />
            <img
              onClick={() => render(3, 'ふくろ')}
              src={bag}
              alt="ふくろ"
              className="items mt-[-11px] w-[21%] h-[100px]"
            />
            <img
              onClick={() => render(4, 'かがみ')}
              src={mirror}
              alt="かがみ"
              className="items mt-[-18px] w-[16%] h-[110px]"
            />
          </div>
        </div>
      </div>
